...
class CreateVideosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('videos', function (Blueprint $table) {
            ...
            $table->string('preview_video')->comment('预览视频')->default('');
            $table->integer('like_num')->comment('点赞数量')->default(0);
            $table->integer('dislike_num')->comment('点踩数量')->default(0);
            $table->integer('need_login')->comment('是否需要登录后才可以查看，1.需要，0.不需要')->default(0);
        });
    }
